...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__board_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__board_js__);
...
class Board {
  ...
  constructor() {
    ...
    for (let i = 0; i < 10 ; i++) {
      ...
      for (let j = 0; j < 10; j++) {
        this.grid[i].push(new __WEBPACK_IMPORTED_MODULE_0__tile_js__["a" /* default */](i, j));
      }
    }

    this.grid[4][4] = new __WEBPACK_IMPORTED_MODULE_1__player_js__["a" /* default */](4, 4);
...
class Player extends __WEBPACK_IMPORTED_MODULE_0__tile_js__["a" /* default */] {
  constructor(x, y) {
    super(x, y);
  }
